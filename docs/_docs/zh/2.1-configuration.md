...
- 先看一下jekyll官方文档，对于liquid有基本了解[官方文档-中文](http://jekyllcn.com/docs/quickstart/) 
- 看其他部署网站的博客/本项目的[README.md](https://github.com/kitian616/jekyll-TeXt-theme/blob/master/README-zh.md)文件，对流程有个大体了解
...
网站的根路径，不包含域名，其默认值为“/”。如果你的网站是搭建在 Github Pages 上的，那么这个值会默认设置为网站对应的项目名[^gitHub_metadata]。如果是建立在**其它服务器**上的，那么就需要切换成对应的网站根路径
